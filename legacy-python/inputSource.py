"""Compatibility shim: import InputSource from the package.

This file remains for backwards compatibility when running scripts
from the repository root. Prefer `from nexuscontroller import InputSource`.
"""

from nexuscontroller.core import InputSource
